...
<div id="tip_msg_box" class="Error_box"  style="display:none;" onclick="$(this).fadeOut();">
  <a href="javascript:void(0)" class="Error_Close" title="关闭"></a>
  <div id="statePic" class="tips_warn_msg"></div>
  <div id="tips_msg" class="Er_list" >
  </div>
</div>
<%-- 
<div style="height:30px;padding:0 0 6px 0;display:none;" id="tip_msg_box" onclick="$(this).fadeOut();">
      <div class="tips" style="height:26px;"  >
         <div class="tips_close"><a href="javascript:void(0)">
            <img src="${res}/images/tips_close.gif" width="14" height="14" border="0" align="middle" /></a>
         </div>
         <div id="tips_msg">
         </div>
      </div>
