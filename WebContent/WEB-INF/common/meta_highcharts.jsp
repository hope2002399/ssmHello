...
<script type="text/javascript" src="${res}/js/plugins/highcharts/modules/exporting.js"></script>
<script type="text/javascript" src="${res}/js/plugins/highcharts/modules/no-data-to-display.js"></script>
<script type="text/javascript" src="${res}/js/plugins/highcharts/themes/grid-light.js"></script>

<script type="text/javascript" src="${res}/js/jquery/jquery.js"></script>
<script type="text/javascript" src="${res}/js/jquery/jquery.PrintArea.js"></script>
<!-- end highchartpie 饼状图-->
